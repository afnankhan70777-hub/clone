...
import { Plus, Save, Trash2, Calculator, Search, ShoppingCart } from 'lucide-react';
...
export function SaleOrders() {
  const [orderNo, setOrderNo] = useState('10');
  const [date, setDate] = useState('05-06-2022');
  const [deliveryDate, setDeliveryDate] = useState('10-06-2022');
  ...
  const updateItem = (id: number, field: keyof SaleOrderItem, value: string | number) => {
    ...
    <div className="h-full flex flex-col p-1">
      ...
      <div className="bg-bg-header text-white px-3 py-1.5 flex items-center justify-between mb-1">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-sm">Sale Orders</span>
        </div>
      ...
      <div className="flex-1 flex flex-col gap-1 overflow-auto">
        ...
        <CustomCard className="p-2">
          <div className="grid grid-cols-4 gap-3">
            <div className="space-y-0.5">
              <Label className="text-text-secondary text-xs">Order No</Label>
              <Input
                value={orderNo}
            ...
            <div className="space-y-0.5">
              <Label className="text-text-secondary text-xs">Delivery Date</Label>
              <Input
                value={deliveryDate}
        ...
        <CustomCard className="p-2">
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="space-y-0.5">
              <Label className="text-text-secondary text-xs">Reference</Label>
              <Input
                value={reference}
