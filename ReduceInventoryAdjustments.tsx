...
const adjustmentsData: InventoryAdjustment[] = [
  { adjustmentNo: 1, adjustmentDate: '15-03-2024', productCode: '1001000008', productName: 'Adams Cheese', warehouse: 'Main Warehouse', quantity: 10, unitCost: 1170, totalValue: 11700, reason: 'Damaged Goods', status: 'Posted' },
  { adjustmentNo: 2, adjustmentDate: '18-03-2024', productCode: '1000000006', productName: 'Sunsilk Shampoo', warehouse: 'Main Warehouse', quantity: 5, unitCost: 850, totalValue: 4250, reason: 'Expired', status: 'Posted' },
  { adjustmentNo: 3, adjustmentDate: '20-03-2024', productCode: '1002000012', productName: 'Lemon Sandwich', warehouse: 'Karachi Warehouse', quantity: 20, unitCost: 144, totalValue: 2880, reason: 'Damaged Goods', status: 'Pending' },
  { adjustmentNo: 4, adjustmentDate: '22-03-2024', productCode: '1003000045', productName: 'Nestle Milk', warehouse: 'Main Warehouse', quantity: 8, unitCost: 180, totalValue: 1440, reason: 'Expired', status: 'Posted' },
  { adjustmentNo: 5, adjustmentDate: '25-03-2024', productCode: '1004000078', productName: 'Coca Cola', warehouse: 'Karachi Warehouse', quantity: 12, unitCost: 120, totalValue: 1440, reason: 'Breakage', status: 'Pending' },
];

export function ReduceInventoryAdjustments() {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 p-2 overflow-auto">
        <CustomCard title="Reduce Inventory Adjustments" className="h-full">
          <DataTable
            columns={columns}
