...
const productsOpeningData: ProductOpeningBalance[] = [
  { productCode: '1001000008', productName: 'Adams Cheese', warehouse: 'Main Warehouse', quantity: 500, unitCost: 1170, totalCost: 585000, taxRegnNo: '1234567' },
  { productCode: '1000000006', productName: 'Sunsilk Shampoo', warehouse: 'Main Warehouse', quantity: 1000, unitCost: 850, totalCost: 850000, taxRegnNo: '1234567' },
  { productCode: '1002000012', productName: 'Lemon Sandwich', warehouse: 'Karachi Warehouse', quantity: 2000, unitCost: 144, totalCost: 288000, taxRegnNo: 'S1234567' },
  { productCode: '1003000045', productName: 'Nestle Milk', warehouse: 'Main Warehouse', quantity: 1500, unitCost: 180, totalCost: 270000, taxRegnNo: '1234567' },
  { productCode: '1004000078', productName: 'Coca Cola', warehouse: 'Karachi Warehouse', quantity: 800, unitCost: 120, totalCost: 96000, taxRegnNo: 'S1234567' },
];

export function ProductsOpeningBalancesTax() {
  ...
  const columns = [
    ...
    { header: 'Product Name', accessorKey: 'productName' as const, width: '250px' },
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 p-2 overflow-auto">
        <CustomCard title="Products Opening Balances (Tax)" className="h-full">
          <DataTable
            columns={columns}
            data={data}
          />
