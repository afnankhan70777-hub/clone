...
const accountsOpeningData: AccountOpeningBalance[] = [
  { accountCode: '1110', accountName: 'Cash in Hand', debit: 189835, credit: 0, taxRegnNo: '' },
  { accountCode: '1120', accountName: 'Bank Accounts', debit: 1641449, credit: 0, taxRegnNo: '' },
  { accountCode: '1130', accountName: 'Accounts Receivable', debit: 800000, credit: 0, taxRegnNo: '1234567' },
  { accountCode: '2110', accountName: 'Accounts Payable', debit: 0, credit: 155879, taxRegnNo: '' },
  { accountCode: '3100', accountName: 'Capital Account', debit: 0, credit: 2475405, taxRegnNo: '' },
];

export function AccountsOpeningBalancesTax() {
  ...
  const columns = [
    ...
    { header: 'Account Name', accessorKey: 'accountName' as const, width: '300px' },
    ...
    { header: 'Tax Regn No', accessorKey: 'taxRegnNo' as const, width: '150px' },
  ];
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 p-2 overflow-auto">
        <CustomCard title="Accounts Opening Balances (Tax)" className="h-full">
          <DataTable
            columns={columns}
            data={data}
          />
