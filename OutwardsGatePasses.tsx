...
import { Plus, Save, Trash2, Calculator, Search, ArrowUpRight } from 'lucide-react';
...
export function OutwardsGatePasses() {
  const [gpNo, setGpNo] = useState('25');
    ...
    <div className="h-full flex flex-col p-1">
      ...
      <div className="bg-bg-header text-white px-3 py-1.5 flex items-center justify-between mb-1">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-sm">Outwards Gate Passes</span>
        </div>
      ...
      <div className="flex-1 flex flex-col gap-1 overflow-auto">
        ...
        <CustomCard className="p-2">
          <div className="grid grid-cols-4 gap-3">
            ...
            <div className="space-y-0.5">
              <Label className="text-text-secondary text-xs">SO No</Label>
              <div className="flex gap-1">
                <Input
                  value={soNo}
